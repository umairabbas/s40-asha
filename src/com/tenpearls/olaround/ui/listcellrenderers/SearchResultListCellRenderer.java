...
public class SearchResultListCellRenderer implements ListCellRenderer, IMemoryManager {
	...
	public Component getListCellRendererComponent(List list, Object value, int index, boolean isSelected) {
		...
		mainContainer.addComponent(getBrandImage());
	...
	private Container getBrandImage() {
		Container leftContainer = getInnerContainer(new BoxLayout(BoxLayout.X_AXIS));
			...
			try {
				...
				if(image != null) {
					...
					leftContainer.getStyle().setMargin(2, 2, 0, 5);
	...
	private Label getCategoryName() {
		...
		cateogryLabel.setText(category.getName().toLowerCase());
